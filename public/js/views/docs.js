...
Views.docs = {
  ...
  _docs: {
    ...
    'tools':
      ...
      '<p>Interactive testing interface for Vigil\'s built-in MCP (Model Context Protocol) server. Test all 36 tools, browse 7 resources, run 8 AI prompt workflows, and connect external AI assistants.</p>' +
      ...
      '<p style="color:var(--text-primary);font-weight:600;margin:12px 0 4px;">36 MCP Tools:</p>' +
    ...
    'api':
      ...
      '<h3 style="color:var(--cyan);margin:16px 0 8px;">MCP Server (36 tools, 7 resources, 8 prompts)</h3>' +
